                      ...
                      <div class="message-body" data-simplebar>
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          ...
                          <div class="w-75 d-inline-block v-middle">
                            ...
                            <span class="d-block text-muted">Congratulate him</span>
                          </div>
                        </a>
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                          ...
                          <div class="w-75 d-inline-block v-middle">
                            ...
                            <span class="d-block text-muted">Salma sent you new message</span>
                          </div>
                        </a>
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                          ...
                          <div class="w-75 d-inline-block v-middle">
                            ...
                            <span class="d-block text-muted">Check your earnings</span>
                          </div>
                        </a>
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                          ...
                          <div class="w-75 d-inline-block v-middle">
                            ...
                            <span class="d-block text-muted">Assign her new tasks</span>
                          </div>
                        </a>
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
                          ...
                          <div class="w-75 d-inline-block v-middle">
                            ...
                            <span class="d-block text-muted">$230 deducted from account</span>
                          </div>
                        </a>
                        <a href="javascript:void(0)" class="py-6 px-7 d-flex align-items-center dropdown-item">
                          <span class="me-3">
