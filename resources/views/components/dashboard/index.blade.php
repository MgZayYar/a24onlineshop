                    ...
                    <div class="col-sm-7">
                      <div class="d-flex align-items-center mb-7">
                        <div class="rounded-circle overflow-hidden me-6">
                          <img src="{{asset('admin/dist/images/profile/user-1.jpg')}}" alt="" width="40" height="40">
                        </div>
                      ...
                      <tbody class="border-top">
                        <tr>
                          <td class="ps-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{asset('admin/dist/images/products/product-1.jpg')}}" class="rounded-2" width="48" height="48" alt="" />
                              </div>
                              <div>
                        ...
                        <tr>
                          <td class="ps-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{asset('admin/dist/images/products/product-2.jpg')}}" class="rounded-2" width="48" height="48" alt="" />
                              </div>
                              <div>
                        ...
                        <tr>
                          <td class="ps-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{asset('admin/dist/images/products/product-3.jpg')}}" class="rounded-2" width="48" height="48" alt="" />
                              </div>
                              <div>
                        ...
                        <tr>
                          <td class="ps-0 border-bottom-0">
                            <div class="d-flex align-items-center">
                              <div class="me-2 pe-1">
                                <img src="{{asset('admin/dist/images/products/product-4.jpg')}}" class="rounded-2" width="48" height="48" alt="" />
                              </div>
                              <div>
